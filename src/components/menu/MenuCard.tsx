    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Customizable badge */}
          {hasCustomization && !soldOut && (
            <div className="absolute top-4 right-4 z-20 bg-gold/90 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full">
              Customize
            </div>
          )}
          ...
          <div className="relative h-48 md:h-56 overflow-hidden">
            ...
            <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-md rounded-full px-3 py-1 border border-black/5">
              <span className="text-gold font-display text-sm">{priceDisplay}</span>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-5">
            ...
            >
              <span>{soldOut ? "Sold Out" : hasCustomization ? "Customize" : "Add to Cart"}</span>
              {!soldOut && (
