  ...
  return (
    ...
    >
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-5 sm:mt-6">
              {settings.instagram && (
                <Link
                  ...
                  className="w-11 h-11 sm:w-10 sm:h-10 rounded-full border border-white/15 flex items-center justify-center text-white/50 hover:border-brown-warm hover:text-brown-warm transition-all duration-300 touch-target"
                >
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 md:px-12 lg:px-20 py-5 sm:py-6 pb-safe-extra flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
