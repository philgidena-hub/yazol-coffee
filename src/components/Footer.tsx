...
export default function Footer() {
  ...
  return (
    <motion.footer
      ...
      className="bg-bg border-t border-cream/6 theme-transition"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          >
            <Link
              href="/"
              className="font-display text-3xl text-cream hover:text-gold transition-colors duration-300 hover:drop-shadow-[0_0_10px_rgb(var(--theme-accent)/0.3)]"
            >
              Yazol
            </Link>
            ...
            <div className="flex items-center gap-4 mt-6">
              <Link
                ...
                className="w-10 h-10 rounded-full border border-cream/10 flex items-center justify-center text-cream/40 hover:border-gold/40 hover:text-gold hover:shadow-[0_0_16px_rgb(var(--theme-accent)/0.2)] transition-all duration-300"
              >
