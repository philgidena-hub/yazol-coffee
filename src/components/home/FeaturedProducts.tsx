    ...
    <>
      ...
      >
        ...
        >
          {/* Customize badge */}
          {hasCustomization && (
            <div className="absolute top-3 right-3 z-10 bg-gold/90 text-white text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full">
              Customize
            </div>
          )}
          ...
          <div className="p-4 sm:p-5">
            <div className="flex items-start justify-between gap-2 mb-1.5 sm:mb-2">
              ...
              <span className="text-gold font-display text-sm sm:text-base flex-shrink-0">
                {priceDisplay}
              </span>
            </div>
